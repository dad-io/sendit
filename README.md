# sendit!
A simple, high-performance, drag-and-drop file transfer tool for local networks. If you like the project please remember to star so others can findit.![sendit](image.png) 
